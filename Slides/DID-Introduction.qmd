...
subtitle: "Recent Methodological Advances and their Relevance to Empirical Work"
...
<span class="alert">Additional Workshop Materials: </span> [https://bcallaway11.github.io/CDC/](https://bcallaway11.github.io/CDC/)
...
<span class="alert">Advanced Materials: </span> [https://github.com/bcallaway11/lsu-workshop](https://github.com/bcallaway11/lsu-workshop)
...
$$\bar{\tau}_i(G_i) = \frac{1}{\T - G_i + 1} \sum_{t=G_i}^{\T} \Big( Y_{i,t}(G_i) - Y_{i,t}(0) \Big)$$
...
To understand the discussion later, it is also helpful to think of $ATT(g,t)$ as a <span class="alert">building block</span> for the other parameters discussed above. For example:

. . .

[Overall ATT]{.alert}
\begin{align*}
  ATT^o = \sum_{g \in \bar{\mathcal{G}}} \sum_{t=g}^{\T} w^o(g,t) ATT(g,t) \qquad \qquad \textrm{where} \quad w^o(g,t) = \frac{\P(G_i=g|U_i=0)}{\T-g+1}
\end{align*}
...
4. Handle covariates in different ways
    ...
    * In @caetano-callaway-2023, we recommend including both changes and levels of covariates
